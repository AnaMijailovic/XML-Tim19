 ...
 *           &lt;element ref="{https://github.com/AnaMijailovic/XML-Tim19}image"/&gt;
 *           &lt;element ref="{https://github.com/AnaMijailovic/XML-Tim19}table"/&gt;
...
public class TComplexParagraph {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "image", namespace = "https://github.com/AnaMijailovic/XML-Tim19", type = Image.class, required = false),
        @XmlElementRef(name = "table", namespace = "https://github.com/AnaMijailovic/XML-Tim19", type = Table.class, required = false),
