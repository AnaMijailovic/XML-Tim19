package com.ftn.scientific_papers.util.XSLFOTransformer;
...
public class XSLFOTransformer {
	...
	public static final String FOP_XCONF = "src/main/java/com/ftn/scientific_papers/util/XSLFOTransformer/fop.xconf";
